...
PROJECT = "oracle-cloud-cost-optimizer"
DOMAIN = "finance"
...
def assess(signal: str) -> Assessment:
    ...
    reason = "Context-aware baseline model for transaction and cost signals to improve financial controls and decision quality."
